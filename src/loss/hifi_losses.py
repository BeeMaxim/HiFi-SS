    ...
    def forward(self, real_melspec, fake_melspec, separated_audios, audios, ids, discriminator, **batch):
        ...
        for p in permutations:
            ...
            for b in range(B):
                ...
                cur_loss[b] += F.l1_loss(fake_melspec[b, p], real_melspec[b]) * 0.5
        ...
        #losses["generator_loss"] = losses["l1_loss"] + losses["sep_loss"] * 45
        # print("OTHER", time.time() - st)
        losses["generator_loss"] = losses["snr_loss"] * 1 + losses["l1_loss"] * 0.5
